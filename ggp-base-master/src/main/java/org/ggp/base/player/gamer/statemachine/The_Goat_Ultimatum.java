...
public class The_Goat_Ultimatum extends FactorGamer {
	protected Player p;
		...
		while(true) {
			...
			for(int i = 0; i < size; ++i) {
				...
				for (List<Move> jointMove : n.legalJointMoves.get(move)) {
					...
					double nodeValue;
					if (succNode.solved) nodeValue = -succNode.solvedValue;
				...
				if (minChild.solved) minValue = minChild.solvedValue;
	...
	public String getName() {
		// TODO Auto-generated method stub
		return "The_Goat_Ultimatum Player";
	}
