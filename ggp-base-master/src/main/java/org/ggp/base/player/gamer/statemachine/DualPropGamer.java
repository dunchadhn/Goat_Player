 ...
 * @author Sam
 */
public abstract class DualPropGamer extends Gamer
{
    // =====================================================================
	...
	public final void metaGame(long timeout) throws MetaGamingException
	{
		try
		{
        	...
        	if (prop_list.size() == 1) {
        		...
        		players = new Dual_Prop[num_threads];
